...
builder.Services.AddScoped<IEmployeePayrollReadWrite, EmployeePayrollReadWrite>();
builder.Services.AddScoped<ICompanyPayrollSettingsReadOnly, CompanyPayrollSettingsReadOnly>();
builder.Services.AddScoped<ICompanyPayrollSettingsReadWrite, CompanyPayrollSettingsReadWrite>();
...
builder.Services.AddScoped<IPayrollPeriodReadOnly, PayrollPeriodReadOnly>();
builder.Services.AddScoped<IPayrollPeriodReadWrite, PayrollPeriodReadWrite>();
...
builder.Services.AddScoped<IPaySlipSecondEntryReadOnly, PaySlipSecondEntryReadOnly>();
builder.Services.AddScoped<IPaySlipSecondEntryReadWrite, PaySlipSecondEntryReadWrite>();
// Sinister policy providers (policy metadata storage)
builder.Services.AddScoped<ISinisterPolicyReadOnly, SinisterPolicyReadOnly>();
builder.Services.AddScoped<ISinisterPolicyReadWrite, SinisterPolicyReadWrite>();
